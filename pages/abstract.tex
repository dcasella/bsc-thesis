...
\begin{abstract}
  ...
  For example, tumor phylogeny often involves the loss of previously acquired traits following the deletion of entire genomic regions.
  ...
  The first polynomial time algorithm for reconstructing a Persistent Phylogeny tree starting from a binary matrix was introduced just a few years back.
