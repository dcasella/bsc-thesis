...
\begin{abstract}
  ...
  Recently, studying character-based phylogeny models allowing for loss of characters gained relevancy. E.g. in tumor phylogeny, the deletion of entire genomic regions often cause loss of (previously acquired) mutations.
